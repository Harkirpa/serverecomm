...
// const { login, register, searchproduct } = require('./Signup/userController');
const { login, register } = require('./signup/userControl');
...
// categoryRouter.post("/login",login)
// categoryRouter.post("/register",register)
// categoryRouter.post("/search", searchproduct);
